...
class URLTests: XCTestCase {
    ...
    func testEmptyFields() {
        let csvURL = Bundle(for: CSVTests.self).urlForResource("empty_fields", withExtension: "csv")!
    ...
    func testQuotes() {
        let csvURL = Bundle(for: CSVTests.self).urlForResource("quotes", withExtension: "csv")!
        csv = try! CSV(url: csvURL)
        let expected = [
